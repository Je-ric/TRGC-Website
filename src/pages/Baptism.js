    ...
    <div>
      ...
      <section className="bg-[#f9f9f9] py-20 px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <blockquote className="border-l-4 border-orange-500 pl-6 text-left text-slate-500 italic text-base md:text-lg">
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-px bg-slate-200">
          {reasons.map((r, i) => (
            <div key={i} className="group relative bg-white p-8 flex gap-5 hover:bg-orange-50 transition-colors duration-300 overflow-hidden">
